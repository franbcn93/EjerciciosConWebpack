(function(a){function b(d){if(c[d])return c[d].exports;var e=c[d]={i:d,l:!1,exports:{}};return a[d].call(e.exports,e,e.exports,b),e.l=!0,e.exports}var c={};return b.m=a,b.c=c,b.d=function(a,c,d){b.o(a,c)||Object.defineProperty(a,c,{enumerable:!0,get:d})},b.r=function(a){'undefined'!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(a,Symbol.toStringTag,{value:'Module'}),Object.defineProperty(a,'__esModule',{value:!0})},b.t=function(a,c){if(1&c&&(a=b(a)),8&c)return a;if(4&c&&'object'==typeof a&&a&&a.__esModule)return a;var d=Object.create(null);if(b.r(d),Object.defineProperty(d,'default',{enumerable:!0,value:a}),2&c&&'string'!=typeof a)for(var e in a)b.d(d,e,function(b){return a[b]}.bind(null,e));return d},b.n=function(a){var c=a&&a.__esModule?function(){return a['default']}:function(){return a};return b.d(c,'a',c),c},b.o=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)},b.p='',b(b.s=0)})([function(a,b,c){'use strict';function d(){const a=`
  ...
  <div id="mostrar_texto"></div><hr>`,b=document.createElement('div');b.innerHTML=a,k.appendChild(b);let c=document.getElementById('texto'),d=document.getElementById('mostrar_texto');m=document.getElementById('button_1');let e=[];m.addEventListener('click',function(){e.push(c.value),d.innerHTML=e})}function e(){const a=`
  ...
  <form>
      ...
      <button type="button" id="mayor">¿Quien es el mayor?</button>
            ...
            <hr>`,b=document.createElement('div');b.innerHTML=a,k.appendChild(b);const c=document.getElementById('generarLista');let d='';c.addEventListener('click',function(){let a=document.getElementById('elementos');for(let a=0;10>a;a++)d+='<option>'+g(1,100)+'</option>';a.innerHTML=d})}function g(a,b){return Math.floor(Math.random()*(b-a))+a}function h(){const a=`
  ...
  <hr>`,b=document.createElement('div');b.innerHTML=a,k.appendChild(b);const c=document.getElementById('insertarNombre');c.addEventListener('click',function(){let a=document.getElementById('nombrePersona');if(''==a.value)alert('El nombre no puede estar vacio');else{const b=document.createElement('div');let c='<li> '+a.value+'</li>';b.innerHTML+=c,k.append(b)}})}function i(){const a=`
              ...
              <hr>`,b=document.createElement('div');b.style.display='visible',b.className='clave',b.id='claveId',b.innerHTML=a,k.append(b);const c=document.getElementById('botonClave'),d=document.getElementById('botonConfirmacion');c.addEventListener('click',function(){const a=document.getElementById('ingresarClave'),b=a.value;a.value='';let c=d.value;console.log(c),c==b&&alert('La contrase\xF1a primera y segunda son correctas.'),d.value=''})}function j(){const a=`<p>Incluimos un nuevo botón, en el que oculta el div anterior al pulsar el input de tipo botón: </p>
  ...
  <hr>`,b=document.createElement('div');b.innerHTML=a,k.append(b);const c=document.getElementById('botonOcultar');c.addEventListener('click',function(){const a=document.getElementById('claveId');a.style.visibility='visible'==a.style.visibility?'hidden':'visible'})}c.r(b);const k=document.body;let l,m;const n=()=>{l=document.querySelectorAll('input'),l.forEach(function(a){a.addEventListener('click',async()=>{console.log(a),console.log('item.value: '+a.value),console.log('item.id: '+a.id),k.style.backgroundColor='opcion1'==a.value?'antiquewhite':'opcion2'==a.value?'beige':'white'})})};(()=>{n(),d(),e(),f(),h(),i(),j()})()}]);